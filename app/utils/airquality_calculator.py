...
def calculate_air_quality_score(pm10_grade: int, pm10_value: int, pm25_grade: int, pm25_value: int, standard: str = "korean") -> int:
    """
    대기질에 따른 점수 계산 (1-5)
    ...
    if pm10_value > 0 or pm25_value > 0:
        ...
        return _calculate_air_quality_score_by_grade(pm10_grade, pm25_grade, standard)
...
def _calculate_air_quality_score_by_grade(pm10_grade: int, pm25_grade: int, standard: str) -> int:
    """
    미세먼지 등급으로 대기질 점수 계산
    """
